...
import ajPanwitImage from "../assets/images/e09da1e7-f3c2-4b1e-a6c9-cf5021852cf5.jpg";
      ...
      <section className="container mx-auto py-8">
        ...
        <div className="grid grid-cols-3 gap-4">
          <p className="text-left col-span-2">
            ...
            Internet of Things โค้ดชุดนี้เป็นโค้ดตัวอย่างในหัวข้อ Hono และ React
            ในวิชานี้
          </p>
        ...
        <p className="text-right mt-8">
          ปัจจุบันค่าเฟ่ และห้องสมุดของเรา อยู่ในช่วงการดูแลของ 66070136 ซึ่ง
          {/* TODO: ชื่อของตนเอง, รหัสประจำตัวนักศึกษา และแนะนำคาเฟ่นี้ต่ออีกสักหน่อย + ใส่รูปของตนเอง (ไม่จำเป็นหากไม่สะดวกใจใส่รูป) */}
          มีบริการโดย พิสิษฐ์ งามเลิศพัฒนสิริ เป็นร้านที่ดี
        </p>
      </section>
